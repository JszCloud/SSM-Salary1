...
public class AdminController {
	...
	/*
	 * @RequestMapping 注解访问action 括号中写的是url action ModelAndView 视图
	 */
	//
	...
	private ModelAndView editAdminUser(Admin admin) {
		System.out.println(admin.getAdminId()+"------111---------");
		System.out.println(admin.getAdminPassword()+"------222---------");
		System.out.println(admin.getAdminName()+"------555---------");
	...
	private ModelAndView addAdminUser(Admin admin) {
		ModelAndView mav = new ModelAndView("forward:/adminUser");
		adminService.regist(admin);		
		return mav;
	}
	//删除
