				...
				<c:if test="${adminUser != null}">
					<c:forEach var="u" items="${adminUser}">
						<tr>
							...
							<a href="${pageContext.request.contextPath}/admin/selectEdit?adminId=${u.adminId}">修改</a>&nbsp;/&nbsp;
							<a href="${pageContext.request.contextPath}/admin/delAdminUser?adminId=${u.adminId}">删除</a></th>
